# Prompt prêt à coller — Le Chat (Mistral)

**Comment s'en servir :** ouvre [Le Chat](https://chat.mistral.ai), copie tout le bloc ci-dessous, colle-le, et remplace la dernière ligne par ton information. Active la recherche web si tu veux que Le Chat vérifie ta source.
...
est sourcé. Contexte du projet (ouvre-le si tu peux, sinon je te le colle) :
